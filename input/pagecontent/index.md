...
Currently two major versions of the IG are supported, with corrosponding API implementations [API Version 1](/air-v1/index.html) and [API Version 2](/air/index.html). 
