...
<div>
The table below lists organisations that issue health provider credentials (licences / practicing certificates). The URLs in the second column are valid values for the system element in the identifier of the organisation referenced .by Immunization.performer.actor.qualification.issuer. These organisations are represented in this guide with <a href='http://hl7.org/fhir/namingsystem.html'>NamingSystem</a> resources.
</div>
