...
Currently two major versions of the IG are supported, with corresponding API implementations [API Version 1](https://healthnz-prm.gitlab.io/air/air-api-fhir-ig-v2/api_v1/index.html) and [API Version 2](https://healthnz-prm.gitlab.io/air/air-api-fhir-ig-v2/api_v2/index.html). 
