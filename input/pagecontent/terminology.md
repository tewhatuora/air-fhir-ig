...
see_also: https://github.com/HL7NZ/nzbase
...
{% sql {
"query": "select coalesce(Title, Name, Id) as Name, Description, Web, Url from Resources where Type = 'ConceptMap' and Url is not null order by coalesce(Title, Name, Id)",
"class": "table table-bordered table-condensed",
"columns": [
{ "source": "Name", "title": "ConceptMap", "type": "link", "target": "Web" },
{ "source": "Description", "title": "Purpose", "type": "markdown" },
{ "source": "Url", "title": "Canonical url", "type": "markdown" }
]
} %}
