...
In this version of the API, `doseNumberPostitiveInt` is used in `protocolApplied` and `recommendation` elements.
...
Version 2 of the API implements [doseNumberString](https://hl7.org/fhir/R4/immunization-definitions.html#Immunization.protocolApplied.doseNumber_x_), anticipating [doseNumber](https://hl7.org/fhir/immunization-definitions.html#Immunization.protocolApplied.doseNumber) in later versions of FHIR.
